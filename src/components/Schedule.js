    ...
    return <View style={{ ...styles.container, marginBottom: 45 }}>
        {
            data.length !== 0 ?
                ...
                :
                <View style={{ flex: 1, backgroundColor: '#101010', padding: 18, borderRadius: 10 }}>
                    <Text style={{ color: '#e1e1e1', fontFamily: 'Inter-Medium', fontSize: 18, textAlignVertical: 'center', marginLeft: 2 }}>
                        Расписания на этот день не найдено
                    </Text>
                    <Text style={{ color: '#c5c5c5', fontFamily: 'Inter-Regular', fontSize: 12, textAlignVertical: 'center', marginLeft: 2, marginTop: 6 }}>
                        Проверьте, может быть этот день - выходной?
                    </Text>
                </View>
        }
    </View>
